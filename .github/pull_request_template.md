...
- [ ] I searched [open issues](https://github.com/pewdiepie-archdaemon/basedcode-ai/issues) and [open PRs](https://github.com/pewdiepie-archdaemon/basedcode-ai/pulls) — this is not a duplicate.
...
- [ ] **Style match**: the change uses BasedCode AI's existing visual language. Specifically:
