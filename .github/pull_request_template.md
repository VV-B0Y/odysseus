...
- [ ] I searched [open issues](https://github.com/VV-B0Y/BasedCode/issues) and [open PRs](https://github.com/VV-B0Y/BasedCode/pulls) — this is not a duplicate.
...
- [ ] **Style match**: the change uses Based code's existing visual language. Specifically:
