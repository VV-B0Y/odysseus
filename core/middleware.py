...
INTERNAL_TOOL_TOKEN = os.environ.get("BASEDCODE_AI_INTERNAL_TOKEN") or secrets.token_hex(32)
INTERNAL_TOOL_HEADER = "X-BasedCode AI-Internal-Token"
...
def require_admin(request: Request):
    ...
    # (a) header-direct (caller set X-BasedCode AI-Internal-Token), or
