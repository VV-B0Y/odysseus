...
#
# IMPORTANT: Set a strong admin password before starting the server.
# If this is left unset, the server will ask you to create a password
# on your first visit to the web UI — which is the recommended approach.
# Only uncomment and pre-set this if you need a non-interactive setup.
# BASEDCODE_AI_ADMIN_PASSWORD=
