"""scripts/_lib/cli.py — shared scaffolding for the `basedcode-ai-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("basedcode-ai-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/basedcode-ai-foo`
...
VERSION = "0.1.0"  # bumped centrally; every basedcode-ai-* CLI reports this
