"""scripts/_lib/cli.py — shared scaffolding for the `basedcode-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("basedcode-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/basedcode-foo`
...
VERSION = "0.1.0"  # bumped centrally; every basedcode-* CLI reports this
