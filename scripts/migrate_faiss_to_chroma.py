...
Migrates:
  - Memory vectors: data/memory_vectors/ -> basedcode-ai_memories collection
  - RAG vectors:    data/rag/            -> basedcode-ai_rag collection
