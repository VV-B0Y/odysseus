...
class TaskScheduler:
    ...
    async def _deliver_via_email(self, output: str, task, result: str):
        ...
        try:
            ...
            msg["X-BasedCode-Origin"] = "basedcode-ui"
            msg["X-BasedCode-Kind"] = "task"
            msg["X-BasedCode-Ref"] = str(task.id)
    ...
    async def _deliver_via_mcp(self, tool_name: str, task, result: str):
        ...
        args = {
            ...
            "body": result,
            "headers": {
                "X-BasedCode-Origin": "basedcode-ui",
                "X-BasedCode-Kind": "task",
                "X-BasedCode-Ref": str(task.id),
            },
        }
        if recipient:
