...
class TaskScheduler:
    ...
    async def _deliver_via_email(self, output: str, task, result: str):
        ...
        try:
            ...
            msg["X-BasedCode AI-Origin"] = "basedcode-ai"
            msg["X-BasedCode AI-Kind"] = "task"
            msg["X-BasedCode AI-Ref"] = str(task.id)
    ...
    async def _deliver_via_mcp(self, tool_name: str, task, result: str):
        ...
        args = {
            ...
            "body": result,
            "headers": {
                "X-BasedCode AI-Origin": "basedcode-ai",
                "X-BasedCode AI-Kind": "task",
                "X-BasedCode AI-Ref": str(task.id),
            },
        }
        if recipient:
