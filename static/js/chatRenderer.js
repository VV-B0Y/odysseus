...
const _ACTION_RECENTS_KEY = 'basedcode-ai-msg-actions-recent';
 ...
 */
const _USER_ACTION_RECENTS_KEY = 'basedcode-ai-user-actions-recent';
    ...
    ctxRing.addEventListener('click', (e) => {
      ...
      if (compactBtn) {
        compactBtn.addEventListener('click', async (e) => {
          ...
          compactRole.textContent = 'BasedCode AI';
...
export function addMessage(role, content, modelName, metadata) {
  try {
    ...
    var _roleText = role === 'user' ? 'You' : (isSlash || isCompacted) ? 'BasedCode AI' : shortModel(resolvedModel);
