...
function initMermaid() {
  if (!window.mermaid || window.__basedcodeMermaidReady) return;
  window.mermaid.initialize({ startOnLoad: false, theme: 'dark', securityLevel: 'loose' });
  window.__basedcodeMermaidReady = true;
}
window.basedcodeInitMermaid = initMermaid;
initMermaid();
...
const THINK_EXPANDED_KEY = 'basedcode-thinking-expanded';
