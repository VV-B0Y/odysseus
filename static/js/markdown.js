...
function initMermaid() {
  if (!window.mermaid || window.__basedcode-aiMermaidReady) return;
  window.mermaid.initialize({ startOnLoad: false, theme: 'dark', securityLevel: 'loose' });
  window.__basedcode-aiMermaidReady = true;
}
window.basedcode-aiInitMermaid = initMermaid;
initMermaid();
...
const THINK_EXPANDED_KEY = 'basedcode-ai-thinking-expanded';
