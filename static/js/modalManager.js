...
const _rememberedDockKey = (id) => `basedcode-ai-modal-remembered-dock-${id}`;
...
function _emitModalOpened(id, modal) {
  try {
    window.dispatchEvent(new CustomEvent('basedcode-ai:modal-opened', {
      detail: { id, modal },
    }));
  } catch (_) {}
}
...
const _DOCK_STORAGE_KEY = 'basedcode-ai.mobileDockState.v1';
