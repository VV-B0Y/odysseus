...
// ── Key constants ──
export const KEYS = {
  THEME: 'basedcode-ai-theme',
  TOGGLES: 'basedcode-ai-toggles',
  ...
  MODELS_EXPANDED: 'basedcode-ai-model-expanded',
  MODEL_ENDPOINTS: 'basedcode-ai-model-endpoints',
  MODEL_SELECTED: 'basedcode-ai-selected-model',
  SORT_ORDER: 'basedcode-ai-sessions-sort',
  CHAT_SEARCH_SCOPE: 'basedcode-ai-search-scope',
  INCOGNITO: 'basedcode-ai-incognito',
  RAG_ACTIVE: 'basedcode-ai-rag-active',
  MCP_ACTIVE: 'basedcode-ai-mcp-active',
  SECTION_ORDER: 'sidebar-section-order',
  ADMIN_LAST_TAB: 'admin-last-tab',
  DENSITY: 'basedcode-ai-density'
};
