...
const LS_KEY = 'basedcode-ai-theme';
const CUSTOM_THEMES_KEY = 'basedcode-ai-custom-themes';
...
const ADV_KEYS = [
  ...
  { key: 'brandColor',         css: '--brand-color',       label: 'BasedCode AI Logo',    group: 'Sidebar' },
...
export function initThemeUI() {
  ...
  if (exportBtnEl) {
    ...
    newExp.addEventListener('click', () => {
      ...
      a.href = url;
      a.download = 'basedcode-ai_' + (obj.name || 'theme') + '.json';
      a.click();
