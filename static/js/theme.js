...
const LS_KEY = 'basedcode-theme';
const CUSTOM_THEMES_KEY = 'basedcode-custom-themes';
...
const ADV_KEYS = [
  ...
  { key: 'brandColor',         css: '--brand-color',       label: 'Based code Logo',    group: 'Sidebar' },
...
export function initThemeUI() {
  ...
  if (exportBtnEl) {
    ...
    newExp.addEventListener('click', () => {
      ...
      a.href = url;
      a.download = 'basedcode_' + (obj.name || 'theme') + '.json';
      a.click();
