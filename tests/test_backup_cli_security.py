...
def _load_backup_cli():
    path = Path(__file__).resolve().parent.parent / "scripts" / "basedcode-ai-backup"
    loader = importlib.machinery.SourceFileLoader("basedcode-ai_backup_under_test", str(path))
