...
def _load_dispatcher():
    path = Path(__file__).resolve().parent.parent / "scripts" / "basedcode-ai"
    loader = importlib.machinery.SourceFileLoader("basedcode-ai_dispatcher_under_test", str(path))
...
def test_is_runnable_subcommand_requires_executable_file(tmp_path):
    ...
    sub = tmp_path / "basedcode-ai-demo"
