...
def _load_dispatcher():
    path = Path(__file__).resolve().parent.parent / "scripts" / "basedcode"
    loader = importlib.machinery.SourceFileLoader("basedcode_dispatcher_under_test", str(path))
