...
base compose with only the matching overlay merged into the ``basedcode-ai``
...
def _merge_overlay_into_base(base: dict, overlay: dict) -> dict:
    """Build the expected standalone config: base + overlay on basedcode-ai only."""
...
# --- Non-basedcode-ai services and volumes untouched ---------------------------
