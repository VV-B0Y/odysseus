...
def _load_mail_cli(monkeypatch):
    ...
    path = Path(__file__).resolve().parent.parent / "scripts" / "basedcode-ai-mail"
    loader = importlib.machinery.SourceFileLoader("basedcode-ai_mail_cli_under_test", str(path))
