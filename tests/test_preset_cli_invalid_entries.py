...
def _load_preset_cli():
    path = Path(__file__).resolve().parent.parent / "scripts" / "basedcode-ai-preset"
    loader = importlib.machinery.SourceFileLoader("basedcode-ai_preset_invalid_entries", str(path))
