...
def _load_sessions_cli(monkeypatch):
    ...
    path = Path(__file__).resolve().parent.parent / "scripts" / "basedcode-sessions"
    loader = importlib.machinery.SourceFileLoader("basedcode_sessions_cli_under_test", str(path))
