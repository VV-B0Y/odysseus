...
def _load_signature_cli(monkeypatch):
    ...
    path = Path(__file__).resolve().parent.parent / "scripts" / "basedcode-ai-signature"
    loader = importlib.machinery.SourceFileLoader("basedcode-ai_signature_cli_under_test", str(path))
